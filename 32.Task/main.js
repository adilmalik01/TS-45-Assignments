...
var current_users = ["adil", "Asif", "Ali", "AZEEM", "Sahil", "talal"];
...
function checkExistUser(current_users, new_users) {
    ...
    var cureentUsertoLower = current_users.map(function (exist) { return exist.toLowerCase(); }); // I used the map loop beceause this is return the value
