...
// solution 
var hero = "Quaid e Azam";
// convert in lowerCase
console.log("lowwercase:", hero.toLowerCase());
// convert in upperCase
console.log("UPPERCASE:", hero.toUpperCase());
// convert in titleCase
var toTitleCase = "muhammad adil malik asif malik";
var titleCaseSplit = toTitleCase.split(" "); // yahan mane string ko array me change kia 
var finalTitleCase = ""; // ye hamari final result div he jisme sara data ayega titleCase ban kr 
// with FOREACH LOOP 
titleCaseSplit.forEach(function (char) {
